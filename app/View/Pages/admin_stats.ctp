	...
	<div class="container">		
		<div class="page-content page-statement">
			<div class="single-head">
				<h3 class="pull-left"><i class="fa fa-desktop lblue"></i> Statistiques</h3>
			...
			<div class="row">
				  ...
				  <?php if($use_paypal == 1){ ?>
					  <div class="col-md-3 col-sm-3">
						<div class="well br-green">
						  <h2><?php echo $paypalAujourdhui; ?></h2>
			  ...
			  <div class="col-md-3 col-sm-3">
				<div class="well br-purple">
				  <h2><?php echo $utilisateursAujourdhui; ?></h2>
